  ...
  module ViewHelpers
    def s3_swf_upload_tag(options = {})
      ...
      out << %(<script type="text/javascript">
        ...
        <a href="#" id='s3_upload_#{@count}' onclick="s3_swf#{@count}.upload('#{prefix}', '#{destinationKey}'); document.body.removeChild(document.getElementById('s3_upload_#{@count}'));">Upload</a>
      )
